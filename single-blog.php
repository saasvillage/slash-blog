<div class="relative mt-4 md:mt-0">
    <div class="grid md:grid-cols-12">
        <div class="blog-content w-full col-span-12 xl:col-start-2 col-span-8 xl:col-span-7 bg-white rounded-lg p-2 mt-4 md:p-6 mb-12 relative mx-auto max-w-7xl pb-12 md:pb-12">
        ...
        <div class="mt-4 w-full col-span-12 md:col-span-4 xl:col-span-3">
            <?php get_sidebar() ?>
        </div>
        <div></div>
    </div>
